            ...
            if(sessionStorage.isVisisted !== "visited") {
                ...
                setTimeout(function(e) {
                    if(document.querySelector('.lowrapper')) {
                        ...
                        var ovlay = document.querySelector('div');
                        ovlay.id = 'ovlay';
