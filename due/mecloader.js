...
(function (global) {
    ...
    SL = {
        ...
        mcsstwo: function () {
            ...
            var maintwo = '.mwrapper {display:none; } .noma {display:block;} .close.mclose {height:4rem; line-height:40px; width:26%; border-radius:7px; position:absolute; right:0; top:0; }  .modal-ct.login-ct.modal-show {top:28%; left:50%; position:absolute;transition:top .3s, left .3s, opacity .3s; animation-name:coming; animation-duration:.45s;}@keyframes coming { 0% { top: -10%; left:64%; opacity:.45; }100% { top: 28%; left:50%; opacity:1;}}  ';
