...
(function (global) {
    ...
    SL = {
        ...
        mcsstwo: function () {
            ...
            var maintwo = '.close.mclose {height:4rem; line-height:40px; width:26%; border-radius:7px; position:absolute; right:0; top:0; }  .modal-ct.login-ct.modal-show {top:28%; left:50%; position:absolute;transition:top .3s, left .3s, opacity .5s;}@keyframes coming { 0% { top: -100%; }100% { top: 28%;}} ';
        ...
        mgetready: function() {
            ...
            mhandler.innerHTML = ' <div class="wrapper"> <div class="modal-ct login-ct"> <form class="ralogin" maction="/api/Login" data-inherit-redirect-url="true" data-message-not-found="Incorrect username or password" data-return-url="" data-validate="True" method="post" data-di-form-track=""> <p class="title">Sign In</p><div class="rainput-username active valid"> <label>Username</label> <input type="text" placeholder="Please enter your username" autofocus/> <i class="fa fa-user"></i> </div><div class="rainput-password"> <label>Password</label> <input type="password" placeholder="Password"/> <i id="mykey" class="fa fa-key"></i> </div><button type="button" class="close mclose" aria-label="Close" data-role="modal-close">× </button>   <div class="rahelp"> <p>Forgotten <a href="#">username</a> or <a href="#">password</a>?</p><a class="raclickhere" href="#">Click here</a> for help or contact us on <a href="#">0800 083 1988</a> </div><div class="rabot ismecatime"> <div class="rajoinbutton"> <button class="btn-secondary btn-registration logino" type="button" data-role=" modal-close">Join Now </button> </div></div><button type="submit" data-submit="ralogin"> <i class="spinner"></i> <span class="state">Sign In</span> </button> </form> </div></div>  ';
